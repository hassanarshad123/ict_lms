<template>
	<div>
		<div class="flex items-center justify-between mb-4">
			...
			<Button v-if="canAddStudents" @click="openStudentModal()">
				<template #prefix>
					<Plus class="h-4 w-4" />
				</template>
				{{ __('Add') }}
...
// Only Admin (Moderator) and Course Creator can add students
// Teachers and Evaluators can only view students
